...
from ppo_agent import Agent as PPO_Agent
...
parser.add_argument("--load-railways", type=boolean, default=False, help="Whether to load in pre-generated railway networks")
...
env = RailEnv(width=flags.grid_width, height=flags.grid_height, number_of_agents=flags.num_agents,
              ...
              malfunction_generator_and_process_data=malfunction_from_params(MalfunctionParameters(1 / 10000, 15, 50)),
...
# Main training loop
for episode in range(start, flags.num_episodes):
    agent.reset()
